...
import AtomWildfly from '../lib/atom-wildfly';
...
describe('AtomWildfly', () => {
  let workspaceElement, activationPromise;

  beforeEach(() => {
    workspaceElement = atom.views.getView(atom.workspace);
    activationPromise = atom.packages.activatePackage('atom-wildfly');
  });

  describe('when the atom-wildfly:run event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        expect(atomWildflyPanel.isVisible()).toBe(true);
        atom.commands.dispatch(workspaceElement, 'atom-wildfly:run');
        expect(atomWildflyPanel.isVisible()).toBe(false);
      });
    });
